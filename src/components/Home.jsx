  ...
  return (
    <div className='grid place-items-center md:h-[75vh] h-[90vh]'>
      <div className='grid md:place-content-center md:w-9/12 w-11/12 gap-10 my-10'>
          ...
          <Link className="border-2 rounded-sm border-white  hover:border-accent bg-accent hover:bg-lime-600 text-white transition-all duration-300 md:w-3/12 p-2 font-Roboto text-center text-xl my-5" to="/signup">Get Started</Link>
      </div>
    </div>
  )
}
