        ...
        <div className='md:w-9/12 w-11/12 my-10'>
            ...
            <div className='h-[50vh] grid place-content-center'>
              <h3 className='text-xl text-zinc-700 my-3 font-OpenSans'>* Authenticate with Google *</h3>
                <button onClick={signInGoogle} type="button" className="text-white bg-accent hover:bg-accent/90 focus:ring-4 focus:ring-accent/50 font-medium rounded-lg text-md px-5 py-4 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
